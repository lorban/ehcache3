 ...
 */
public class DefaultManagementRegistryFactoryConfiguration implements ServiceConfiguration<DefaultManagementRegistry> {
  ...
  public DefaultManagementRegistryFactoryConfiguration addConfiguration(StatisticsProviderConfiguration<?> configuration) {
